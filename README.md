...
Dado que el usuario se encuentra en la pequeña ventana de confirmación para actualización de datos

Cuando el usuario seleccione Aceptar

Entonces la aplicación actualizará los datos

Y mostrará un mensaje diciendo “Datos actualizados correctamente”    | EP002    |
